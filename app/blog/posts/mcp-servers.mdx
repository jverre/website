---
title: 'MCP Servers are great - Wait are they really?'
date: '2024-02-22'
summary: 'MCP servers provide LLMs with a structured way to interact with another application, but is it any different from function calling ?'
---
...
![MCP Server Diagram](/blog/img/mcp-servers-protocol.png)
